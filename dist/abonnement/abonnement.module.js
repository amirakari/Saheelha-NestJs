...
AbonnementModule = __decorate([
    common_1.Module({
        imports: [typeorm_1.TypeOrmModule.forFeature([abonnement_entity_1.AbonnementEntity, boutique_entity_1.BoutiqueEntity])],
        controllers: [abonnement_controller_1.AbonnementController],
        providers: [abonnement_service_1.AbonnementService, boutique_service_1.BoutiqueService],
    })
], AbonnementModule);
